...
import cs102groupproject.Server.GoogleCredentialManager;
...
public class AuthService {
     ...
     * @return
     */
    public static String login(UserCredentials credentials) {
        return null;
    }
     ...
     * @return
     */
    public static String register(UserCredentials credentials) {
        return null;
    }
}